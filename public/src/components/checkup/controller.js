...
exports.infodoctor = exports.getCheckup_byDoctor = exports.getCheckup_byPatient = exports.update_checkup = exports.delete_checkup = exports.get_checkup = exports.add_checkup = void 0;
...
const infodoctor = async (req, res) => {
    try {
        const getcheckup = await supabase_1.supabase.from("Schedule").select("id_doctor, Doctor(firstname, lastname, specialty, Specialties(name)), date, start_time, end_time");
        return (0, responses_1.success)({
            res,
            message: "Doctorinfo",
            data: getcheckup.data
